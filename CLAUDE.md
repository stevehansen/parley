...
- `src/Parley/Update/` — NuGet update check, `parley update` (Windows trampoline script), service registration (schtasks / launchd / systemd user).
...
- Never auto-apply updates: updating kills every session's shim.
